...
\subsection*{Ingredients}\label{ingredients-74}}
...
\hypertarget{muffins-flourless-fluffy}{%
\section{MUFFINS (FLOURLESS \& FLUFFY)}\label{muffins-flourless-fluffy}}
...
\tightlist
\item
  Preheat oven to 350° and prepare a muffin tin with 12 muffin liners.
\item
...
\item
  Divide the batter among the 12 muffin cups. Using a ¼ cup measure should distribute the batter pretty evenly.
\item
  Bake at 350° until the muffins have risen, and feel firm to a light touch in the center of the muffin, about 20 to 25 minutes.
\item
  Allow to cool for at least 30 minutes before removing from the pan.
\item
  These muffins can be served at room temperature once they have cooled, but it is recommend storing them in the refrigerator for the best shelf life. They should last for up to a week in the fridge when stored in an airtight container. You can freeze them for up to 3 months in an airtight container.
\end{enumerate}
...
\subsection*{Ingredients}\label{ingredients-81}}
...
\subsection*{Ingredients}\label{ingredients-91}}
...
\hypertarget{cinnamon-applesauce-ornaments}{%
\section*{CINNAMON APPLESAUCE ORNAMENTS}\label{cinnamon-applesauce-ornaments}}


\hypertarget{chef-roberta-sepncer}{%
\subsection*{Chef: Roberta Sepncer}\label{chef-roberta-sepncer}}


\hypertarget{ingredients-109}{%
\subsection*{Ingredients}\label{ingredients-109}}
...
\hypertarget{chef-roberta-spencer-42}{%
\subsection*{Chef: Roberta Spencer}\label{chef-roberta-spencer-42}}


\hypertarget{ingredients-110}{%
\subsection*{Ingredients}\label{ingredients-110}}
...
\subsection*{Ingredients}\label{ingredients-111}}
...
\hypertarget{cranberry-jubilee-sauce}{%
\section*{CRANBERRY JUBILEE SAUCE}\label{cranberry-jubilee-sauce}}


\hypertarget{chef-alvin-spencer-2}{%
\subsection*{Chef: Alvin Spencer}\label{chef-alvin-spencer-2}}


\hypertarget{ingredients-112}{%
\subsection*{Ingredients}\label{ingredients-112}}
...
Place all ingredients except nuts and celery in large sauce pan and bring to a full boil. Use a hard paddle to stir mixture and pop the cranberries as they boil. Whole berries tend to burst open as they boil. Use the hard paddle to push any whole berries against the side of the bowel to pop any that do not open by themselves. After mixture starts to boil, add nuts and celery for added crunch. Boil at a low boil for about 5 minutes or until mixture is a jam-like consistency. Add water if necessary to adjust consistency. Remove from heat. Let cool for at least 30 minutes. Serve hot or cold.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\hypertarget{cheese-ball}{%
\section*{CHEESE BALL}\label{cheese-ball}}


\hypertarget{chef-roberta-spencer-43}{%
\subsection*{Chef: Roberta Spencer}\label{chef-roberta-spencer-43}}
...
\item
  3/4 cup of chopped walnuts - or nuts of our choice
\end{itemize}
...
\hypertarget{combine-all-ingredients-except-the-nuts-in-a-bowel.-mix-well.-form-the-cheese-into-a-ball-or-log-and-roll-into-the-chopped-nuts.-wrap-air-tight-and-chill.-excellent-for-gifting-to-friends.}{%
\section{Combine all ingredients except the nuts in a bowel. Mix well. Form the cheese into a ball or log and roll into the chopped nuts. Wrap air tight and chill. Excellent for gifting to friends.}\label{combine-all-ingredients-except-the-nuts-in-a-bowel.-mix-well.-form-the-cheese-into-a-ball-or-log-and-roll-into-the-chopped-nuts.-wrap-air-tight-and-chill.-excellent-for-gifting-to-friends.}}

\hypertarget{recipe-template}{%
\chapter*{RECIPE TEMPLATE}\label{recipe-template}}


\hypertarget{example-recipe}{%
\section*{EXAMPLE RECIPE}\label{example-recipe}}


\begin{figure}
\centering
\includegraphics{images/macarons.jpg}
\caption{\label{fig:example-macarons}A pretty picture of tasty food, from \href{https://pixabay.com/photos/macarons-raspberries-pastries-2548827/}{pixabay}.}
\end{figure}

\hypertarget{french-fry-shakes}{%
\section*{FRENCH FRY SHAKES}\label{french-fry-shakes}}


\hypertarget{chef-ronald-mcduck}{%
\subsection*{Chef: Ronald McDuck}\label{chef-ronald-mcduck}}
...
\item
  buy new pants
\item
  copy this template to add new recipes, upload an image to the images folder if you'd like
\end{enumerate}
